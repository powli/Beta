...
{ //d9b81799de621722acdba808d34d9123c99bdee8
    ...
    public class UserState
    {
        ...
        //Not yet used. Accepts the spoils generated by another UserStates "Die" function
        ...
        public Spoils Die(UserState target)
        {
            Die();
            return CalculateSpoils(target);

        }

        public Spoils CalculateSpoils(UserState target)
        {
            int xp = 1;
            int healthPot = 0;
            var stamPot = 0;
